...
export function DataImportSettings() {
  ...
  const exportDatabaseSql = async () => {
    try {
      ...
      if (!response.ok) throw new Error("Protocol extraction failure");
          ...
          <div className="bg-slate-50/50 dark:bg-slate-950/20 border border-border/50 rounded-lg p-6 space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Button onClick={exportDatabaseSql} className="w-full h-10 bg-blue-600 hover:bg-blue-700 text-white transition-all text-[11px] font-bold gap-2 shadow-md">
